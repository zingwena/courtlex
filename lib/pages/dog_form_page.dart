import 'package:courtlex/common_widgets/age_slider.dart';
import 'package:courtlex/common_widgets/client_selector.dart';
import 'package:courtlex/common_widgets/color_picker.dart';
...
class _DogFormPageState extends State<DogFormPage> {
  ...
  static final List<Clients> _breeds = [];
  ...
  Future<List<Clients>> _getBreeds() async {
    final breeds = await _databaseService.clients();
